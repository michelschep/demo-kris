...
- [ ] 2.1 Create `sketch.js` with `setup()` — full-screen canvas, white background
- [ ] 2.2 Implement `draw()` — render "Kris" centered using large bold font
...
- [ ] 3.1 Serve with `npx serve .` and verify "Kris" appears centered in browser
- [ ] 3.2 Confirm left half is red and right half is blue
